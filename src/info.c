...
state_t original_states[NUMSTATES] = {
  ...
  {SPR_PLAY,7,10,{A_PlayerScream},S_PLAY_DIE3}, // S_PLAY_DIE2
  {SPR_PLAY,7,10,{A_Fall},S_PLAY_DIE4}, // S_PLAY_DIE3
  {SPR_PLAY,7,10,{NULL},S_PLAY_DIE5},  // S_PLAY_DIE4
  {SPR_PLAY,7,10,{NULL},S_PLAY_DIE6},  // S_PLAY_DIE5
  {SPR_PLAY,7,10,{NULL},S_PLAY_DIE7},  // S_PLAY_DIE6
  {SPR_PLAY,7,-1,{NULL},S_NULL}, // S_PLAY_DIE7
